...
;Set up palette
	...
	ifd GEN_UsePalette
		...
		move.l #GEN_Palette,a1
		
		move.w #16-1,d2
GenPaletteAgain:		
		move.w (a1)+,(VDP_data)
		dbra d2,GenPaletteAgain
...
; Setup Bitmap screen
	...
	;Vram: $C000+(4*2)+(64*4) = 4 lines down 4 , 4 chars across 
	move.l #$41080003,a6 		;top 4=write, bottom $3=Cxxx range $108
	
	move.l #256,d3				;First Tilenum
	move.l #24-1,d2				;Height
TileFillLoopY:		
	move.l a6,-(sp)
		move.l A6,(VDP_ctrl)	;$C00004 Select VRAM
		move.l #32-1,d1			;Width
TileFillLoopX:	
		move.w d3,(VDP_data)	;Send a tile
		addq.w #1,d3			;Next tile 
		dbra d1,TileFillLoopX
	move.l (sp)+,a6
	add.l #$00800000,a6			;Down one line $0080 
	dbra d2,TileFillLoopY		
