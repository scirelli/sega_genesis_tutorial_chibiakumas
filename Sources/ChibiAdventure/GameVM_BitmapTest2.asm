smallsintable equ 1
smallsintable32 equ 1
;usesmallangleapprox equ 1
...
HspriteNum equ FlipLut+256	;dc.b 0 		
...
;testt:
	...
	;dc.w $2
		...
		; ld D6 / l,90		;Distance (Radius / Hypotenuse of triangle )
		; ld d0 / a,3		;Color
		; ld d2 / d,128	;Xpos 
		; ld d5 / e,96		;Ypos 	
				
		move.l #90,d6		;Distance (Radius / Hypotenuse of triangle )
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	include "ChibiVM_AdvMathsSinCos32.asm"
...
ProgramLaunch:
	...
	db %10111100
	dwww $0001,0,50
	dww 100,0		;Color,SX,SY,DX,DY
	MBcall mbDrawLine	;(x0,y0, x1,y1) ;Src R6,R4 Dest R8,R10=Yoffset  R0=Color
	
	
	
	dbb SYSi,syscallLoadMultiReg		;This will be better for setting 3+ regs
	db %10110000
	dwww $0003,$1010,0		;Color,XY,0.XH
	MBcall mbFillArea		;R7.R5 =Xpos R4=Ypos R0=Color
	
	

	dbbw mov16x,r6_imm16,APacket-VramBase
	MBcall mbDrawPacket		;R8/9=Xpos R10/11=Ypos R6=Packet R0=Scale R1=Color
