...
DoubleBuffered equ 1		;Need to draw tilemap every time for hsprite
...
CacheAddr1 equ MaxTileData+$0000	;3 * 512 byte caches for 3
CacheAddr2 equ MaxTileData+$0200	;   thirds of the screen
...
VscreenMinX equ 64		;Top left of visible screen in logical co-ord
VscreenMinY equ 80

VscreenWid equ 128		;Visible Screen Size in logical units
VscreenHei equ 96
	
VscreenWidClip equ 2	;Alter right boundary 
VscreenHeiClip equ 2	;Alter bottom boundary
...
;REMINDER: Shrunk sprites can cause 'glitches' as bits of the next tile may be used even if you've not set it.
;Set unused sprite tiles to a transparent tile to fix this	
