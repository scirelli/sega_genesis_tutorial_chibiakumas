...
mul8ZeroH:
	...
	and.l #$000000FF,d3
	mulu.w d0,d3  	;This routine performs the operation HL=HL*A	
	rts
	

	;D3 = SIN(D0)*D2 / hl=sin(a)*d	
sin_a_times_d:
	and.l #$000000FF,d2
    btst #7,d2; bit 7,d
...
sinetable:
		...
		ifd smallsintable32
			...
			dc.b 127	;One extra value for our 'Tween' calculations that are at the end of the table 
		else
