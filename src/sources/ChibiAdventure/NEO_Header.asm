...
flag_VBlank	equ  $10ED01   	;(byte) vblank flag in ram
	...
	ds.l 3,$00C00426	; Reserved
	dc.l $00C0042C		; Uninitialized Interrupt Vector
	ds.l 8,$00C00426		; Reserved
	...
	ds.l 4,$00000000		; Level 4-7 interrupt

	ds.l 16,$FFFFFFFF	; TRAP #0-15 Instruction
	ds.l 16,$FFFFFFFF	; Reserved
...
softDips_All:	;Software Dip Switches (a.k.a. "soft dip")
	dc.b "CHIBIAKUMAS.COM " 		; Game Name
...
USER:	
	...
	clr.w $3C0006			;LSPC_MODE - Disable auto-animation, timer interrupts
	...
	clr.b d0				;Handle user request
	move.b $10FDAE,d0		;BIOS_USER_REQUEST
...
userReq_Game:
	...
	;        -RGB			;Color Num:
	move.w #$0000,$401FFE	;0 - Background color (Black)
	move.w #$0808,$400022	;1 - Purple
	move.w #$00FF,$400024	;2 - Cyan
	move.w #$0FFF,$400026	;3 - White
