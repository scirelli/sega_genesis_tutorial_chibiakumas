...
drawtile:
	...
	; move.l #ScreenBase+2,a6
	; jsr prepareVram
	; move.w #2,(VDP_data) ;C00000 Select tile for mem loc
...
drawtilebasiconly:
	...
	asl.l #8,d0
	or.w d0,d3	;NNNNNNNN nnnn----
	
	
	lsr.w #4,d3 ;----NNNN NNNNnnnn
	
	add.l a1,d3			;Add Tile Base
...
drawtiledouble:
	addq.l #1,a2
	move.b (a2),d3	;------bb nnnnnnnn - tile number
	addq.l #1,a2
	
	
	add.l a1,d3			;Add Tile Base
	add.l #patterndoubleheight,d3
	;LPPVHTTT TTTTTTTT	   T=Tille number  H=Hflip  V=vflip  P=palette number   L=Layer (in front of /behind sprites)
	move.w d3,(VDP_data) 
	jmp tiledone
